...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public function new(dialogueList:DialogueFile, ?song:String = null)
	{
		...
		daText = new TypedAlphabet(DEFAULT_TEXT_X, DEFAULT_TEXT_Y, '', '', null, false, 24);
		add(daText);
	...
	function startNextDialog():Void
	{
		...
		if(curDialogue.font == null) curDialogue.font = 'dialogue.ttf';
		...
		trace(curDialogue.text);
		daText.font = curDialogue.font;
		trace(curDialogue.font);
		...
		if(char != null) {
			char.playAnim(curDialogue.expression, daText.finishedText);//ここ?
