...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		{
			var optionText:Alphabet = new Alphabet(200, 360, optionsArray[i].name, true, 36);
			optionText.offset.y += 74;
			...
			if(optionsArray[i].type == 'bool') {
				...
				optionText.snapToPosition();
				var valueText:AttachedText = new AttachedText(Std.string(optionsArray[i].getValue()), Alphabet.textwidth + 28, -72, true, 0.8);
