...
typedef FlxTexturePackerSource = OneOfTwo<String, TexturePackerObject>;//TexturePackerAtlas -TexturePackerSource    TexturePackerObject
...
class FlxAssets
{
	...
	#if (!macro || doc_gen)
	// fonts
	public static var FONT_DEFAULT:String = "Gen Jyuu Gothic Bold";
